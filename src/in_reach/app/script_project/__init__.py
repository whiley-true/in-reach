...
from the project; the compile flow calls it before compiling). See :mod:`.project` for what is
...
from .project import LoadedBlock, LoadedModule, MergedKind, ScriptProject, SourceFile, is_linked, load_project
